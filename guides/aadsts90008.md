...
tokenforitselfrequiresgraphpermission - the user or administrator hasn't

consented to use the application. at the minimum, the application requires
access to microsoft entra id by specifying the sign-in and read user profile
permission..
