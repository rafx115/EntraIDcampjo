...
invalidgrantredeemagainstwrongtenant - provided authorization code is intended
to use against other tenant, thus rejected. oauth2 authorization code must be
redeemed against same tenant it was acquired for (/common or /{tenant-id} as
appropriate).
