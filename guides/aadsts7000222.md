...
invalidclientsecretexpiredkeysprovided - the provided client secret keys are

expired. create new keys for your app, or consider using certificate credentials
for added security:https://aka.ms/certcreds.
